...
class DepartamentsView extends GetView<DepartamentsController> {
  const DepartamentsView({super.key});
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Get.rootDelegate.toNamed('${AppRoutes.departaments}/new');
                  },
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          onTap: () {
                            Get.rootDelegate.toNamed('/adm/departamentos/${rol.id}');
                          },
                        ),
                      );
                    },
